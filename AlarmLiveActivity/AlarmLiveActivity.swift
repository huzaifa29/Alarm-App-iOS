...
struct AlarmLiveActivity: Widget {
    ...
    func lockScreenView(attributes: AlarmAttributes<CustomAlarmMetaData>, state: AlarmPresentationState) -> some View {
        VStack {
    ...
    func bottomView(attributes: AlarmAttributes<CustomAlarmMetaData>, state: AlarmPresentationState) -> some View {
        HStack {
    ...
    @ViewBuilder func alarmTitle(attributes: AlarmAttributes<CustomAlarmMetaData>, state: AlarmPresentationState) -> some View {
    ...
    @ViewBuilder func cookingMethod(metadata: CustomAlarmMetaData?) -> some View {
...
struct AlarmProgressView: View {
    var cookingMethod: CustomAlarmMetaData.Method?
